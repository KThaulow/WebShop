...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(helpers, router, tokenService) {
    ...
    LoginComponent.prototype.login = function () {
        var _this = this;
        var authValues = { "Username": "kristian", "Password": "secret" };
        this.tokenService.auth(authValues).subscribe(function (token) {
            _this.helpers.setToken(token);
...
var LogoutComponent = /** @class */ (function () {
    function LogoutComponent(router, helpers) {
        this.router = router;
        this.helpers = helpers;
    }
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(router, helper) {
        this.router = router;
        this.helper = helper;
    }
...
var AppComponent = /** @class */ (function () {
    function AppComponent(helpers) {
        this.helpers = helpers;
        this.title = 'Angular 5 Seed';
    }
    AppComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.subscription = this.helpers.isAuthenticationChanged().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["startWith"])(this.helpers.isAuthenticated()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["delay"])(0)).subscribe(function (value) {
            return _this.authentication = value;
        });
    };
...
var BaseService = /** @class */ (function () {
    ...
    BaseService.prototype.header = function () {
    ...
    BaseService.prototype.setToken = function (data) {
        this.helper.setToken(data);
    };
    BaseService.prototype.failToken = function (error) {
...
var TokenService = /** @class */ (function (_super) {
    ...
    TokenService.prototype.getToken = function (body) {
        return this.http.post(this.pathAPI + 'token', body, _super.prototype.header.call(this)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(_super.prototype.handleError));
    };
